...
<div id="uniteModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Ajouter une unité de vente</h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'unitevente.store', 'class' => 'form-horizontal panel']) !!}
