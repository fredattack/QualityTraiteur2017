<div id="familleModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Ajouter une famille de plat</h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'familleplat.store', 'class' => 'form-horizontal panel']) !!}
