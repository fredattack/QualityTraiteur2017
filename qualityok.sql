...
-- Export de données de la table tuto.advise : ~11 rows (environ)
/*DELETE FROM `advise`;*/
...
DELETE FROM `famillesandwiche_sandwiche`;
...
-- Export de données de la table tuto.famille_sandwiches : ~4 rows (environ)
DELETE FROM `famille_sandwiches`;
...
-- Export de données de la table tuto.ingredients : ~32 rows (environ)
...
-- Export de données de la table tuto.ingredient_sandwiche : ~56 rows (environ)
DELETE FROM `ingredient_sandwiche`;
...
-- Export de données de la table tuto.platsprepares : ~0 rows (environ)
DELETE FROM `platsprepares`;
...
-- Export de données de la table tuto.sandwiches : ~0 rows (environ)
